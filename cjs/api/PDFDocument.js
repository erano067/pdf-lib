...
class PDFDocument {
    ...
    getSavedAttachments() {
        ...
        return rawAttachments.flatMap(({ fileName, fileSpec }) => {
            ...
            const description = fileSpec.lookup(core_1.PDFName.of('Desc')).decodeText();
            return [
                {
    ...
    save(options = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { useObjectStreams = true, addDefaultPage = true, objectsPerTick = 50, updateFieldAppearances = true, rewrite = false, } = options;
    ...
    saveIncremental(snapshot, options = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return core_1.PDFWriter.forContextWithSnapshot(this.context, objectsPerTick, snapshot).serializeToBuffer();
        });
    }
    /**
    ...
    commit(options = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const incrementalBytes = yield this.saveIncremental(snapshot, options);
