...
class PDFContext {
    ...
    nextRef() {
        ...
        const ref = PDFRef_1.default.of(this.largestObjectNumber);
        if (this.snapshot)
    ...
    getRef(pdfObject) {
        if (pdfObject instanceof PDFRef_1.default)
            return pdfObject;
    ...
    obj(literal) {
        if (literal instanceof PDFObject_1.default) {
            ...
            return PDFHexString_1.default.fromBytes(literal);
        }
    ...
    getLiteral(obj, { deep = true, literalRef = false, literalStreamDict = false, literalString = false, } = {}) {
        ...
        if (obj instanceof PDFArray_1.default) {
            const lit = obj.asArray();
            return deep ? lit.map((value) => this.getLiteral(value, cfg)) : lit;
        }
        else if (obj instanceof PDFBool_1.default) {
            return obj.asBoolean();
        }
        else if (obj instanceof PDFDict_1.default) {
            const lit = {};
        ...
        else if (obj instanceof PDFName_1.default) {
            return obj.decodeText();
        }
        else if (obj === PDFNull_1.default) {
            return null;
        }
        else if (obj instanceof PDFNumber_1.default) {
            return obj.asNumber();
        }
        else if (obj instanceof PDFRef_1.default && literalRef) {
            return obj.objectNumber;
        }
        else if (obj instanceof PDFStream_1.default && literalStreamDict) {
            return this.getLiteral(obj.dict, cfg);
        }
        else if ((obj instanceof PDFString_1.default || obj instanceof PDFHexString_1.default) &&
            literalString) {
            return obj.asString();
        }
        return obj;
    ...
    objectContains(container, target) {
        if (container === target)
            return true;
        if (container instanceof PDFDict_1.default) {
        ...
        else if (container instanceof PDFArray_1.default) {
            for (let i = 0, len = container.size(); i < len; i++) {
                if (this.objectContains(container.get(i), target))
                    return true;
            }
        }
        else if (container instanceof PDFStream_1.default) {
