...
export declare const assertIsOneOf: (value: any, valueName: string, allowedValues: {
...
export type TypeDescriptor = 'null' | 'undefined' | 'string' | 'number' | 'boolean' | 'symbol' | 'bigint' | DateConstructor | ArrayConstructor | Uint8ArrayConstructor | ArrayBufferConstructor | FunctionConstructor | [
    Function,
    string
];
